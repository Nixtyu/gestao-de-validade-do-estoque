...
estoque_mercearia = [
    ...
    Produto("Nutella 350g", "16/06", "Lote 1", "Mercearia")
    Produto("Nutella 350g", "18/11", "Lote 2", "Mercearia")
    Produto("Paçoquinha Mascavo 210g", "18/05", "Lote Único", "Mercearia")
    Produto("Mucilon arroz e aveia 180g", "01/05", "Lote 1", "Matinal")
    Produto("Mucilon arroz e aveia 180g", "01/08", "Lote 2", "Matinal")
    Produto("Mucilon arroz e aveia 180g", "01/10", "Lote 3", "Matinal")
    Produto("Mucilon arroz e aveia 180g", "01/11", "Lote 4", "Matinal")
    Produto("Mucilon multicerais 180g", "01/12", "Lote Único", "Matinal")
    Produto("Mucilon milho 180g", "01/06", "Lote 1", "Matinal")
    Produto("Mucilon milho 180g", "01/07", "Lote 2", "Matinal")
    Produto("Mucilon milho 180g", "01/08", "Lote 3", "Matinal")
    Produto("Mucilon milho 180g", "01/11", "Lote 4", "Matinal")
    Produto("Massa de bolo vilma abacaxi", "12/06", "Lote Único", "Mercearia")
    Produto("Massa de bolo vilma floresta negra", "19/05", "Lote 1", "Mercearia")
    Produto("Massa de bolo vilma floresta negra", "14/07", "Lote 2", "Mercearia")
    Produto("Massa de bolo vilma laranja", "10/06", "Lote 1", "Mercearia")
    Produto("Massa de bolo vilma laranja", "23/06", "Lote 2", "Mercearia")
    Produto("Massa de bolo vilma limao", "18/06", "Lote Único", "Mercearia")
    Produto("Massa de bolo vilma chocolate suave", "24/05", "Lote 1", "Mercearia")
    Produto("Massa de bolo vilma chocolate suave", "11/06", "Lote 2", "Mercearia")
    Produto("Massa de bolo vilma broa de fuba", "30/06", "Lote Único", "Mercearia")
    Produto("Massa de bolo vilma baunilha", "29/06", "Lote Único", "Mercearia")
    Produto("Massa de bolo vilma festa", "06/05", "Lote 1", "Mercearia")
    Produto("Massa de bolo vilma festa", "04/06", "Lote 2", "Mercearia")
    Produto("Massa de bolo vilma leite condesado", "20/06", "Lote Único", "Mercearia")
    Produto("Massa de bolo vilma cenoura", "22/06", "Lote Único", "Mercearia")
]
